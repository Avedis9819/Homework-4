...
import com.example.homework4.ui.screens.NewsList
                        ...
                        is Result.Success -> {
                            ...
                            composable(route = NewsScreens.HomeScreen.route) {
                                NewsList(
                                    ...
                                    onFilterSelected = {
                                        viewModel.loadNewsWithCategory(it)
                                    },
                                    onSearch = {
                                        viewModel.search(it)
                                    }
                            ...
                            composable(NewsScreens.DetailsScreen.route + "/{index}",
...
//                                        delay(1000)
//                                        viewModel.loadNewsWithCategory(
//                                            selectedCategory.toString().lowercase()
//                                        )
//                                        isRefreshing = false
//                                    }
//                                }
